...
<style>
    ...
    .page-shopping-cart .check-span {
        ...
        width: 24px;
        height: 20px;
        background: url("../static/shopping_cart.png") no-repeat 0 0; }
    .page-shopping-cart .check-span.check-true {
        background: url("../static/shopping_cart.png") no-repeat 0 -22px; }
    ...
    .page-shopping-cart .cart-product table .product-num .num-reduce span {
        background: url("../static/shopping_cart.png") no-repeat -40px -22px;
        display: block;
        width: 6px;
        height: 2px;
        margin: 13px auto 0 auto; }
    .page-shopping-cart .cart-product table .product-num .num-add span {
        background: url("../static/shopping_cart.png") no-repeat -60px -22px;
        display: block;
        width: 8px;
        height: 8px;
    ...
    .page-shopping-cart .cart-product-info .delect-product span {
        ...
        width: 13px;
        height: 15px;
        background: url("../static/shopping_cart.png") no-repeat -60px 0; }
    ...
    .page-shopping-cart .cart-product-info .keep-shopping span {
        ...
        width: 15px;
        height: 15px;
        background: url("../static/shopping_cart.png") no-repeat -40px 0; }
    ...
    .page-shopping-cart .cart-worder .choose-worder span {
        ...
        width: 22px;
        height: 22px;
        background: url("../static/shopping_cart.png") no-repeat -92px 0; }
    ...
    .choose-worker-box .box-title a {
        ...
        width: 10px;
        height: 10px;
        background: url("../static/shopping_cart.png") no-repeat -80px 0; }
    .choose-worker-box .box-title a:hover {
        background: url("../static/shopping_cart.png") no-repeat -80px -22px; }
                 ...
                 productList:[
                    {
                        ...
                        'pro_num': 3,//数量
                        'pro_img': '../static/testimg.jpg',//图片链接
                        'pro_price': 500//单价
                    },{
                        'pro_name': '【斯文】物品2',//产品名称
                        'pro_brand': 'skc',//品牌名称
                        'pro_place': '韩国',//产地
                        'pro_purity': '99.7%',//规格
                        'pro_min': "215千克",//最小起订量
