<template>
    <div id="tab">
        ...
        <div class="tab-tit">
            ...
            <a href="javascript:;" v-on:click="curId=0" :class="{'cur':curId===0}">html</a>
            <a href="javascript:;" v-on:click="curId=1" :class="{'cur':curId===1}">css</a>
            <a href="javascript:;" v-on:click="curId=2" :class="{'cur':curId===2}">javascript</a>
